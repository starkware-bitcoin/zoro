...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t border-slate-700 bg-surface-alt/50 font-medium [&>tr]:last:border-b-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-slate-700 transition-colors hover:bg-surface-alt/60 data-[state=selected]:bg-surface-alt",
      className
    )}
    {...props}
  />
