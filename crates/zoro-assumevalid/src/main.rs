...
use zoro_assumevalid::prove::{prove, ProveParams};

/// Zoro AssumeValid - Generate assumevalid arguments and prove Cairo programs
#[derive(Parser)]
#[command(name = "zoro-assumevalid")]
#[command(about = "Generate assumevalid arguments and prove Cairo programs")]
#[command(version)]
struct Cli {
    /// Bridge node RPC URL
    #[arg(long, default_value = "https://staging.zoro.wtf")]
    bridge_url: String,
...
enum Commands {
    ...
    Prove {
        ...
        #[arg(
            long,
            default_value = "crates/zoro-assumevalid/compiled/assumevalid.executable.json"
        )]
        executable: PathBuf,
